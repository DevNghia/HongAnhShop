					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="tel:0393179455"><i class="fa fa-phone"></i> 0393179455</a></li>
								<li><a href="mailto:nghiahieumd@gmail.com"><i class="fa fa-envelope"></i> nghiahieumd@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
