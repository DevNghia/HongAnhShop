                    ...
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="/trang-chu"><img
                                    src="{{ asset('frontend/images/logo-shop-dien-thoai-7-removebg-preview.png') }}"
                                    width="200px" alt="" /></a>
                        </div>
...
======= --}}
    ...
    <script async defer crossorigin="anonymous"
        src="{{ asset('https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v15.0&appId=695872028369099&autoLogAppEvents=1') }}"
        nonce="j0H0MxnG"></script>
                ...
                swal({
                    ...
                    function(isConfirm) {
                        if (isConfirm) {
                            ...
                            if (!shipping_email || !shipping_name || !shipping_address || !
                            ...
                            $.ajax({
                                ...
                                data: {
                                    _token: _token,
                                    // redirect: null
                                    total: order_total_after
                                },
                                success: function(response) {
                                    if (response.code === '00') {
                                        window.location.href = response
                                            .data; // Chuyển hướng người dùng đến URL được trả về
                                    } else {
                                        console.error(
