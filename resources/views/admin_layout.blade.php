    ...
    <ul class="nav top-menu">
        ...
        <li id="header_inbox_bar" class="dropdown">
            ...
            <ul class="dropdown-menu extended inbox">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('frontend/images/3.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('frontend/images/1.png')}}"></span>
                                <span class="subject">
                ...
                <li>
                    <a href="#">
                        <span class="photo"><img alt="avatar" src="{{asset('frontend/images/2.png')}}"></span>
                                <span class="subject">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="/all-order">Liệt kê đơn hàng</a></li>
                ...
                <li class="sub-menu">
                 ...
                 <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="/add-banner">Thêm Banner</a></li>
						<li><a href="/all-banner">Liệt kê Banner</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="/add-blog">Thêm bài viết</a></li>
						<li><a href="/all-blog">Quản lý bài viết</a></li>
                  ...
                  <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="/all-account">Quản lý khách hàng</a></li>
...
CKEDITOR.replace( 'hidden_snippet' )
CKEDITOR.replace( 'hidden_snippet1' )
//                function createTextSnippet() {
                
//     //example as before, replace YOUR_TEXTAREA_ID
//     var html=CKEDITOR.instances.hidden_snippet.getSnapshot();
...
<script type="text/javascript">
    $("#formValidation").validate({
        ...
        rules:{
           ...
           product_content:{
                required: function() 
                        {
                         CKEDITOR.instances.hidden_snippet.updateElement();
                        },
   ...
   brand_product_desc:{
        required: "Mô tả Thương hiệu không được bỏ trống",
		    minlength: "Mô tả thương hiệu phải có ít nhất 2 ký tự"
    },
     product_name:{
    ...
    product_desc:{
                required: "Môt tả sản phẩm không được bỏ trống",
                
            },
    product_content:{
                required: "Nội dung sản phẩm không được bỏ trống",
...
<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="frontend/js/flot-chart/excanvas.min.js"></script><![endif]-->
...
<!-- calendar -->
	<script type="text/javascript" src="{{asset('frontend/js/monthly.js')}}"></script>
	<script type="text/javascript">
